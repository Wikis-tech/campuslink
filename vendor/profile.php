...
<head>
  ...
  <title>Vendor Profile — Campuslink</title>
...
<header class="site-header glass-header">
  <div class="header-inner container">
    ...
    <nav class="main-nav">
      ...
      <a href="/vendor/profile" class="nav-link active">Profile</a>
    </nav>
  </div>
</header>
...
<main class="profile-page">
  <div class="container">
    ...
    <form class="profile-form" action="/api/update-vendor-profile.php" method="POST">
