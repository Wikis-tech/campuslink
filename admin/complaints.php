...
$complaints = $db->query("SELECT c.*, u.first_name, u.last_name, v.name as vendor_name FROM complaints c JOIN users u ON c.user_id = u.id JOIN vendors v ON c.vendor_id = v.id ORDER BY c.created_at DESC LIMIT 50")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Manage Complaints — Campuslink</title>
...
<header class="site-header glass-header">
  <div class="header-inner container">
    ...
    <nav class="main-nav">
      ...
      <a href="/admin/complaints" class="nav-link active">Complaints</a>
    </nav>
  </div>
</header>
        ...
        <tbody>
          <?php foreach ($complaints as $complaint): ?>
            <tr>
              ...
              <td><?php echo htmlspecialchars($complaint['vendor_name']); ?></td>
