...
.policy-meta{background:#fef2f2;border:1px solid #fecaca;border-radius:10px;padding:0.85rem 1rem;margin-bottom:1.5rem;font-size:0.78rem;color:#dc2626;}
...
.sev-title{font-weight:800;font-size:0.82rem;margin-bottom:0.4rem;}
...
<div class="policy-body">
    ...
    <div class="policy-section">
        ...
        <div class="severity-box sev-high">
            <div class="sev-title">🔴 Immediate Permanent Removal</div>
        ...
        <div class="severity-box sev-med">
            <div class="sev-title">🟡 Temporary Suspension (7–30 days)</div>
            <ul style="margin:0;padding-left:1.25rem;">
        ...
        <div class="severity-box sev-low">
            <div class="sev-title">🟢 Warning Issued First</div>
            <ul style="margin:0;padding-left:1.25rem;">
