...
.value-card .vi{margin-bottom:0.5rem;display:flex;justify-content:center;color:#1a56db;}
.value-card .vi svg{width:32px;height:32px;}
...
.about-stat .asv{display:flex;justify-content:center;margin-bottom:0.35rem;color:#1a56db;}
.about-stat .asv svg{width:28px;height:28px;}
.about-stat .asl{font-size:0.72rem;color:#64748b;font-weight:600;margin-top:0.2rem;}
</style>

<div class="about-hero">
    <div style="display:flex;justify-content:center;margin-bottom:0.75rem;color:#fff;">
...
<div class="about-body">
    ...
    <div class="about-section">
        <h2>
            <i data-lucide="target" style="width:20px;height:20px;color:#1a56db;flex-shrink:0;"></i>
            Our Mission
        </h2>
    ...
    <div class="about-stats">
        <div class="about-stat">
            <div class="asv"><i data-lucide="shopping-cart"></i></div>
            <div class="asl">Verified Vendors</div>
        </div>
        <div class="about-stat">
            <div class="asv"><i data-lucide="graduation-cap"></i></div>
            <div class="asl">Student Users</div>
        </div>
        <div class="about-stat">
            <div class="asv"><i data-lucide="star"></i></div>
            <div class="asl">Honest Reviews</div>
        </div>
        <div class="about-stat">
            <div class="asv"><i data-lucide="shield"></i></div>
    ...
    <div class="about-section">
        <h2>
            <i data-lucide="layout" style="width:20px;height:20px;color:#1a56db;flex-shrink:0;"></i>
            What We Do
        </h2>
