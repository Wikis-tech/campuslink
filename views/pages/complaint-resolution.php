...
.policy-meta{background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:0.85rem 1rem;margin-bottom:1.5rem;font-size:0.78rem;color:#1d4ed8;}
.step-row{display:flex;gap:1rem;align-items:flex-start;margin-bottom:1rem;padding:0.85rem;background:#f8fafc;border-radius:10px;border:1px solid #e2e8f0;}
.step-num{width:28px;height:28px;border-radius:50%;background:linear-gradient(135deg,#1a56db,#0e9f6e);color:#fff;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:0.75rem;flex-shrink:0;}
...
<div class="policy-hero">
    <h1>⚖️ Complaint Resolution Policy</h1>
...
<div class="policy-body">
    ...
    <div class="policy-section">
        ...
        <p>Use your ticket ID to track your complaint at any time: <a href="<?= SITE_URL ?>/complaints/track" style="color:#1a56db;font-weight:700;">Track Complaint →</a></p>
    </div>
</div>