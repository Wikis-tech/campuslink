...
border-radius:9px;font-size:0.9rem;outline:none;transition:border 0.2s;box-sizing:border-box;}
...
.vendor-login-btn{display:flex;align-items:center;justify-content:center;gap:0.45rem;
text-align:center;padding:0.65rem;border:1.5px solid #e2e8f0;border-radius:9px;
font-size:0.85rem;font-weight:700;color:#374151;text-decoration:none;transition:border-color 0.2s;}
.vendor-login-btn:hover{border-color:#1a56db;}
.vendor-login-btn svg{width:15px;height:15px;stroke:currentColor;fill:none;stroke-width:2;}
</style>
...
<div class="auth-page">
  <div class="auth-box">
    <div class="auth-box-header">
      ...
      <p>Student Login &middot; <?= e(SCHOOL_NAME) ?></p>
    </div>
    <div class="auth-box-body">
      ...
      <form method="POST" action="<?= SITE_URL ?>/login">
        ...
        <button type="submit" class="auth-btn">
            <i data-lucide="log-in" style="width:16px;height:16px;stroke:#fff;fill:none;stroke-width:2;"></i>
            Sign In
        </button>
      </form>
      <div class="divider">or</div>
      <a href="<?= SITE_URL ?>/vendor/login" class="vendor-login-btn">
        <i data-lucide="store"></i> Vendor Login
      </a>
    </div>
    <div class="auth-box-footer">
      No account? <a href="<?= SITE_URL ?>/register">Create one free &rarr;</a>
    </div>
  </div>
</div>
