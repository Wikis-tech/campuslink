...
-- The canonical student/vendor access helper must exist BEFORE product RLS policies.
...
-- Tighten vendor discovery so marketplace safety cannot be bypassed by generic selects.
