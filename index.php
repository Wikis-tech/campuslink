...
if ($seg0 !== '') {
    ...
    if ($seg0 === 'vendor') {
        ...
        if ($seg1 === 'payment') {
            ...
            if ($seg2 === 'csrf')     { $paymentCtrl->csrf();           exit; }
            ...
            <?php if (!empty($featuredVendors)): ?>
                ...
                <div class="vendor-card">
                    ...
                    <div class="vendor-actions">
                        ...
                        <a href="https://wa.me/<?= formatWhatsAppNumber($vendor['whatsapp_number']) ?>?text=Hi%2C%20I%20found%20your%20listing%20on%20CampusLink"
