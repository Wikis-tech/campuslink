...
export default async function ReviewsPage({ searchParams }: { searchParams: Promise<{ success?: string; error?: string }> }) {
  ...
  return <>
    <header className="admin-topbar"><div><span className="admin-pill"><MessageSquareText size={15}/> Reputation moderation</span><h1>Reviews</h1><p>Student feedback stays connected to both the Student identity and the Vendor it affects, while Vendors cannot rewrite moderation state.</p></div></header>
